...
<p>Тернарный оператор <i class="tblack">Условие?Истинно:Ложно</i> возвращает значение получающееся в результате вычисления выражения (или как у меня, готовое значение) между ?  и : если условие перед ? выполняется.
