...
$lang['email_must_be_russian'] = 'С 1 декабря зарегистрироваться на отечественных сайтах можно только по номеру телефона, по почте российских сервисов, по ЕБС и через Госуслуги.' . "\n\nНа этом сайте вы можете использовать для регистрации один из почтовых доменов:";
