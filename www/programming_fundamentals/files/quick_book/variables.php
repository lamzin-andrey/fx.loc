...
<p>Переменные в программировании - это всё. Программист почти никогда не (ну или очень редко) имеет дело с конкретными точными
...
Определять можно и без него, но я очень постараюсь объяснить сразу, почему так делать не надо.</p>
...
Без тени иронии утверждаю, сравнение переменной с надписанной коробкой  - это прекрасно, лучше вряд ли придумать.</p>
...
Например я хочу вывести на веб-странице "псевдоокно" поверх всех других "псевдоокон".
...
<p>У меня возможно будет функция, определяющая самый "близкий к смотрящему на экран" элемент. Это свойство элементов веб-страниц задается свойством css z-index.
...
<div style="width:96%">
<div class="left"><a href="<?=WEB_ROOT?>/quick_start/keywords">Назад - <?=$lang['keywords']?></a></div>
<div class="right"><a href="<?=WEB_ROOT?>/quick_start/datatypes">Далее - <?=$lang['datatypes']?></a></div>
