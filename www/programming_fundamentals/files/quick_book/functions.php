...
Прочтите подсказку к ключевому слову <pre class="no_lines"><b>Object</b></pre></p><p> чтобы снять вопросы.</p>
...
<p>Также прочтите подсказки к ключевым словам <pre class="no_lines"><b>function</b>
...
<?=QuickStartHandler::prevnext('datatypes', 'begin');?>
