...
<b>if</b> (x > 2 && x < 5) ("Если x больше двух и меньше пяти..."). Если нас интересует интервал [2,5], запись будет <b>if</b> (x >= 2 && x <= 5). ИЛИ может использоваться, когда нас устраивают какие-то из списка значений переменной, например если x равно 1 или 4, нужно сделать сделать что-то... Тогда пишем <b>if</b> (x == 1 || x == 4). </p>
