...
<p>Если этот текст будут читать программисты, они наверное скажут, что неплохо бы получить факториал через рекурсивные вызовы. Но на мой взгляд эта статья и так перегруженна, тем более что то, что я собираюсь сообщить в ней еще на мой взгляд не менее важно, чем рекурсивные алгоритмы.</p>
