...
<pre class="no_lines"><b>while</b>(x <= 40) {
	//...
	x++;
}</pre>
...
<pre class="no_lines">
<b>for</b> (<b>var</b> i = array.length - 1; i >= 0; i--) { <span class="strcolor">//Будет выполняться, пока i > 0, сравнение с нулем происходит быстрее чем с любым другим числом
</span>	<span class="strcolor">//тут что-то делаем
</span>}
</pre>
