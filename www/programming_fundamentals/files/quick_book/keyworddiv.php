...
'>throw</b>  <b title='//Буквально "пытаться". Пример см. в подсказке для catch'>try</b>  <b title='//Буквально "Неопределено". Специальное значение, которому равна любая переменная, которой не присвоено значение. Например
