...
'>null</b>  <b title='//Определяет тип данных (объект типа) Простой объект. На самом деле этот тип данных называется просто Объект, но я буду использовать всюду словосочетание "Простой объект", чтобы избежать путаницы, так как в JavaScript практически вообще всё можно назвать объектом и вы при этом очень редко ошибетесь. Простыми объектами удобно описывать реальные и 
