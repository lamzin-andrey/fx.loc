...
Однако, перечитав подсказки я не могу сказать, что блестяще справился с этой задачей. Например, описывая слово with я не мог не упомянуть о том, что в strict mode его использование невозможно уже сейчас, однако не стал объяснять что такое strict mode. Такие вещи не должны вас смущать, все что вы не поняли во время чтения подсказки должно для вас проясниться по ходу чтения книги.
</p>
