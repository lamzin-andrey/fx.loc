...
alert(10);//выведет 10
'>Number</b>  <b title='Буквально "ноль". Но это не ноль! 
...
<b title='Буквально "прототип". Свойство, которое есть у любой функции JavaScript.
...
'>prototype</b>  <b title='Буквально "Неопределено". Специальное значение, которому равна любая переменная, которой не присвоено значение. Например
...
'>undefined</b>  <b title='Буквально "с". От этого слова JavaScript скоро избавится, оно уже недоступно в use strict mode. Однако "не в use strict mode" на мой взгляд лет пять у нас точно есть ;-).
